...
class SetUpConfig:
    ...
    random_subsample_each_graph: bool = False                   # If True, resample latent tokens per graph when using random tokens
...
class ModelConfig:
    ...
    latent_tokens_size: Any = (64, 64)     # Latent token dimensions (H,W) or (H,W,D) or N
